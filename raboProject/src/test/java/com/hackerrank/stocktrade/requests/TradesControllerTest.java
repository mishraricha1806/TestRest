...
public class TradesControllerTest {
    ...
    /**
     * @throws Exception It tests creating trade
     */
    @Test
    @Order(1)
    ...
    /**
     * @throws Exception It tests finding trade
     */
    @Test
    @Order(3)
    ...
    /**
     * @throws Exception It tests finding trades by stock symbol
     */
    @Test
    @Order(5)
    ...
    /**
     * @throws Exception It tests finding trades by non-existing stock symbol
     */
    @Test
    @Order(6)
    ...
    /**
     * @throws Exception It tests finding trades by user id
     */
    @Test
    @Order(7)
    ...
    /**
     * @throws Exception It tests finding trades by non-existing user id
     */
    @Test
    @Order(8)
    ...
    /**
     * @throws Exception It tests finding trades by user id and stock symbol
     */
    @Test
    @Order(9)
    ...
    /**
     * @throws Exception It tests finding all the trades
     */
    @Test
    @Order(13)
